...
export async function analyzeTabs(params: Record<string, unknown>, requestId: string, deps: TabDeps) {
...
export async function inspectTabs(params: Record<string, unknown>, requestId: string, deps: TabDeps) {
